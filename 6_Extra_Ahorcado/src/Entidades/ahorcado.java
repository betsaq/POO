...
public class ahorcado {
    ...
    private int palabras_maximas=10;

    public ahorcado() {
    }

    public ahorcado(int letra, String[] palabra, int palabras_maximas) {
        this.letra = letra;
        this.palabra = palabra;
        this.palabras_maximas = palabras_maximas;
    }
    ...
    public int getPalabras_maximas() {
        return palabras_maximas;
    }

    public void setPalabras_maximas(int palabras_maximas) {
        this.palabras_maximas = palabras_maximas;
    }
